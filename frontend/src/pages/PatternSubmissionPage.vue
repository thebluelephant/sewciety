...
export default {
  ...
  setup() {
    useMeta({ title: "Sewciety - Proposer un patron de couture", content : "Votre patron de couture n'est pas encore disponible sur Sewciety ? Soumettez-le pour proposer à votre tour un tutoriel de réalisation " });
  },
  data() {
    return {
      name: null,
